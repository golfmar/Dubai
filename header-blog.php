      ...
      <header class="header header--blog">
        ...
        <div class="container">
          ...
          <div class="header__body">
            ...
            <div class="header__info info"><a class="info__phone _hover" href="javascript:void(0);">+7(000) 123 45 65 67
              </a><a class="book-button btn btn-success but-wave popups-init-js" rel="#popup-header"
                href="javascript:void(0);">Book a consultation</a></div>
          </div>
        </div>
      </header>